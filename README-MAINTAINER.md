...
- name the post like: **µOS++ platform-sifive-arty v2.0.0 released**
...
- `npm dist-tag add @xpack-sifive/platform-arty@2.0.0 latest`
- `npm dist-tag ls @@xpack-sifive/platform-arty`
...
- paste the release name like **µOS++ platform-sifive-arty v2.0.0 released**
