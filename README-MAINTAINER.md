...
```sh
rm -rf ~/Work/micro-os-plus/platform-sifive-arty-xpack.git && \
mkdir -p ~/Work/micro-os-plus && \
git clone \
  https://github.com/micro-os-plus/platform-sifive-arty-xpack.git \
  ~/Work/micro-os-plus/platform-sifive-arty-xpack.git
```
...
```sh
xpm run install-all -C ~/Work/micro-os-plus/platform-sifive-arty-xpack.git
xpm run test-all -C ~/Work/micro-os-plus/platform-sifive-arty-xpack.git
```
