...
- name the post like: **µOS++ platform-sifive-arty v1.1.0 released**
...
- `npm dist-tag add @xpack-sifive/platform-arty@1.1.0 latest`
- `npm dist-tag ls @@xpack-sifive/platform-arty`
...
- paste the release name like **µOS++ platform-sifive-arty v1.1.0 released**
