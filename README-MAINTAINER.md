...
- name the file like `2020-12-19-platform-sifive-arty-v0-1-0-released.md`
- name the post like: **µOS++ platform-sifive-arty v1.0.3 released**
- update the `date:` field with the current date
- update the GitHub Actions URLs using the actual test pages

If any, refer to closed
[issues](https://github.com/micro-os-plus/platform-sifive-arty/issues)
as:
...
- `npm dist-tag add @xpack-sifive/platform-arty@1.0.3 latest`
- `npm dist-tag ls @@xpack-sifive/platform-arty`
...
- paste the release name like **µOS++ platform-sifive-arty v1.0.3 released**
